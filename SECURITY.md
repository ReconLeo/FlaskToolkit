...
| Version | Support |
|---------|---------|
| **v4.x (Community Edition)** | ✅ Actively maintained — security fixes are backported and land in the next patch or minor release, with the usual full regression (27 scripts / 674 assertions) + CI |
