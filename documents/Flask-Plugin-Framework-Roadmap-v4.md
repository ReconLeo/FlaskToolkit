...
| **v4.17.1（当前）** | 签名功能验证 + 修复自更新/插件更新源验签 bug（update_checker/plugin_updates._verify_feed_signature 漏传 signature，配公钥后签名永远失败）：新增 test_plugin_updates 8 + test_release_sign 5，扩展 test_package_sign 25 + test_update_checker 50，全量回归 43 脚本 1143 项，tag v4.17.1 已发布 |
